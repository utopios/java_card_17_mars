...
set CAP_AGG=%SAMPLES_DIR%\%SAMPLE_NAME%\applet\deliverables\AggregatorApplet\com\oracle\jcclassic\samples\arrayview\AggregatorApplet\javacard\AggregatorApplet.cap
...
set ARGS_CLIENT="-capClient=%CAP_CLI% -capServer=%CAP_SRV% -capShared=%CAP_SHR% -capAggregator=%CAP_AGG% -props=%PROPS%"
